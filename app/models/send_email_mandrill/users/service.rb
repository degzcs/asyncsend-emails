...
module SendEmailMandrill
  module Users
    class Service < SendEmailMandrill::GenericService
      ...
      class << self
        ...
        def async_send_templates_to_users(user_ids, performer = nil)
          ...
          if user_ids.present?
            operation = MandrillOperation.create(service: 'SendEmailMandrill::Users::Service',
        ...
        def recipients_from_user(user)
          SendEmailMandrill::Users::Recipient.wrap(user)
        end
